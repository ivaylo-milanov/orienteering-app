...
const CatalogFilter = ({ searchParams, changeSearchParams }) => {
    ...
    const returnSortValue = () => {
        return `${searchParams.get("sortField")}_${searchParams.get(
            "sortDir"
        )}`;
    };
                ...
                <div className="flex justify-between items-center">
                    <div className="flex items-center space-x-4">
                        ...
                        <select
                            ...
                            value={returnSortValue() || ""}
                            className="px-4 py-2 bg-white border border-gray-300 rounded-md text-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 hover:border-indigo-500 transition duration-200 ease-in-out"
                        >
                            <option value="">Select Sort</option>
                            <option value="eventDate_asc">
                                Event Date - Ascending
                            </option>
                            <option value="eventDate_desc">
                                Event Date - Descending
                            </option>
                            <option value="eventName_asc">
                                Event Name - Ascending
                            </option>
                            <option value="eventName_desc">
